...
# final model 
gh=symarfima.fit(pt,p=5, q=48,  index1 = 10, fit.alpha = T, cons=T, 
           max.fun=10000,fixed.ar = c(NA,0,0,0,0),
           fixed.ma=c(NA,0,0,0,rep(0,19),NA,rep(0,23),NA),h=24)
# 
